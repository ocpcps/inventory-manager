 ...
 * @created 03.01.2022
 */
public class ScriptRuleException extends BasicException {

    public ScriptRuleException() {
    }

    public ScriptRuleException(String msg) {
        super(msg);
    }
    ...
    public ScriptRuleException(String msg, Throwable cause) {
        super(msg, cause);
    }
