 ...
 */
@Component
public class IconResourceDao extends AbstractArangoDao<IconModel> {

    public GraphList<IconModel> findUpperResources(IconModel resource) throws ArangoDaoException, ResourceNotFoundException, InvalidRequestException {
        try {
            ...
            return this.query(filter, IconModel.class, this.getDb());
    ...
    @Override
    public IconModel findResource(IconModel resource) throws ArangoDaoException, ResourceNotFoundException {
        try {
            //
...
//            }
            ...
            FilterDTO filter = new FilterDTO(aql, bindVars);
            GraphList<IconModel> result = this.query(filter, IconModel.class, this.getDb());
            if (result.isEmpty()) {
    ...
    @Override
    public DocumentCreateEntity<IconModel> insertResource(IconModel resource) throws ArangoDaoException {
        //
    ...
    @Override
    public DocumentCreateEntity<IconModel> upsertResource(IconModel resource) throws ArangoDaoException {
        //
        // A complexidade de validação dos requistos do dado deve ter sido feita na dao antes de chegar aqui.
        //
    ...
    @Override
    public DocumentUpdateEntity<IconModel> updateResource(IconModel resource) throws ArangoDaoException {
        //
        // A complexidade de validação dos requistos do dado deve ter sido feita na dao antes de chegar aqui.
        //
        try {
            return this.getDb().collection(resource.getDomain().getServices()).updateDocument(resource.getKey(), resource, new DocumentUpdateOptions().returnNew(true).mergeObjects(false).returnOld(true).keepNull(false).waitForSync(false), IconModel.class);
        } catch (Exception ex) {
            throw new ArangoDaoException(ex);
        } finally {
            //
    ...
    @Override
    public MultiDocumentEntity<DocumentUpdateEntity<IconModel>> updateResources(List<IconModel> resources, Domain domain) throws ArangoDaoException {
        try {
            ArangoCollection connectionCollection = this.getDb().collection(domain.getServices());
            return connectionCollection.updateDocuments(resources, new DocumentUpdateOptions().returnNew(true).returnOld(true).keepNull(false).mergeObjects(false), IconModel.class);
        } catch (Exception ex) {
            throw new ArangoDaoException(ex);
        }
    }
    ...
    @Override
    public DocumentDeleteEntity<IconModel> deleteResource(IconModel resource) throws ArangoDaoException {
        try {
            return this.getDb().collection(resource.getDomain().getServices()).deleteDocument(resource.getId(), IconModel.class, new DocumentDeleteOptions().returnOld(true));
        } catch (Exception ex) {
            throw new ArangoDaoException(ex);
        }
    }
    ...
    @Override
    public GraphList<IconModel> findResourcesBySchemaName(String attributeSchemaName, Domain domain) throws ArangoDaoException, ResourceNotFoundException, InvalidRequestException {
        try {
    ...
    @Override
    public GraphList<IconModel> findResourcesByClassName(String className, Domain domain) throws ArangoDaoException, InvalidRequestException, ResourceNotFoundException {
        try {
    ...
    @Override
    public GraphList<IconModel> findResourceByFilter(FilterDTO filter, Domain domain) throws ArangoDaoException, ResourceNotFoundException {
        String aql = "";
        try {
